        ...
        if (isset($_POST['submit'])) {
            ...
            if (!$toko) {
                ...
                try {
                    ...
                    $mtran = "SELECT * FROM mtran WHERE plu LIKE '%$plu%' AND docnoenc LIKE '%$struk%' AND shift LIKE '%$shift%' AND station LIKE '%$station%' AND tanggal LIKE '%$tanggal%' GROUP BY docno";
