<section class="wrapper pt-24 pb-[100px]">
    <main class="content bg-white max-w-screen-xl mx-auto rounded-md py-6 px-4 xl:px-20">
        ...
        <div class="flex justify-between border-b-2 mb-6 pb-2">
            <h1 class="text-2xl font-semibold uppercase">Tambah NIK TOKO</h1>
        </div>
        <form action="<?= BASEURL; ?>jutsu/addnikup" method="POST">
            <div class="form grid grid-cols-1 gap-4">
                ...
                <div class="w-full md:w-1/2 mx-auto">
                    <input type="text" name="nik" class="bg-gray-50 border border-gray-300 text-lg rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Masukkan NIK" maxlength="10" required>
                </div>

                <div class="w-full md:w-1/2 mx-auto">
                    <input type="text" name="nama" class="bg-gray-50 border border-gray-300 text-lg rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Masukkan NAMA" maxlength="255" required>
                </div>

                <div class="w-full md:w-1/2 mx-auto">
                    <input type="text" name="password" class="bg-gray-50 border border-gray-300 text-lg rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Masukkan PASSWORD" maxlength="255" required>
                </div>

                <div class="w-full md:w-1/2 mx-auto">
                    <input type="text" name="initial" class="bg-gray-50 border border-gray-300 text-lg rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Masukkan NAMA INITIAL" maxlength="4" required>
                </div>

                <div class="w-full md:w-1/2 mx-auto">
                    <select name="jabatan" class="bg-gray-50 border text-lg border-gray-300 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5">
                        <option value="CHIEF OF STORE">CHIEF OF STORE</option>
                        <option value="STORE SR. LEADER">STORE SR. LEADER</option>
                        <option value="STORE JR. LEADER">STORE JR. LEADER</option>
                        <option value="STORE CREW BOY">STORE CREW BOY</option>
                        <option value="STORE CREW GIRL">STORE CREW GIRL</option>
                        <option value="I-DELIVERY CREW">I-DELIVERY CREW</option>
                    </select>
                </div>
