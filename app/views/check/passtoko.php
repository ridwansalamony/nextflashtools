<section class="wrapper pt-24 pb-[100px]">
    <main class="content bg-white max-w-screen-xl mx-auto rounded-md py-6 px-4 xl:px-20">
        ...
        <div class="flex justify-between border-b-2 mb-6 pb-2">
            <h1 class="text-2xl font-semibold uppercase">Cek Data Passtoko</h1>
        </div>
        <form action="<?= BASEURL; ?>check/passtokoup" method="POST">
            <div class="form grid grid-cols-1 gap-4">
                ...
                <div class="w-full md:w-1/2 mx-auto">
                    <input type="text" name="nik" class="bg-gray-50 border border-gray-300 text-lg rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Pisahkan dengan koma jika lebih dari 1 NIK : 20xxxxxxxx,20xxxxxxxx" required>
                </div>
